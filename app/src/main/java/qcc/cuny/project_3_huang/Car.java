...
public class Car extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button homeButton = findViewById(R.id.btnHome);
        //
        ...
        payment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (yearEntered > 6 || yearEntered < 1) {
                    Toast.makeText(Car.this, "Please enter a year between 1 and 6", Toast.LENGTH_LONG).show();
                }
                else if (loanEntered > 5000 || loanEntered < 1000) {
                    Toast.makeText(Car.this, "Please enter a loan  amount between $1000 and $5000", Toast.LENGTH_LONG).show();
                }
                else if (intEntered > 9 || intEntered < 1) {
                    Toast.makeText(Car.this, "Please enter an interest rate between 1% and 9%", Toast.LENGTH_LONG).show();
                }
                else {
                    //
